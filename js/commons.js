...
var Dom = {
  ...
  hide: function(ele, type)				 { Dom.get(ele).style.display = "none";
  }
}
...
Game.Load = {
  ...
  images: function(names, callback) { // load multiple images and callback when ALL images have loaded
    ...
    for(n = 0 ; n < names.length ; n++) {
      ...
      result[name].src = "assets/metamap/" + name + ".png";
    }
...
Game.Math = {
  ...
  getAngle:	function(a,b) { return this.normalizeAngle360(Math.atan2(b.y - a.y, b.x - a.x) * 180 / Math.PI); },
